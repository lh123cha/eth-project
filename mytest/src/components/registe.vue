  ...
  <div  class="login-wrap">
    <el-form  class="login-container" :rules="rules">
      ...
      <el-form-item label="" prop="username_val">
        <el-input type="text" placeholder="student number" v-model="id" autocomplete="off"></el-input>
      </el-form-item>
      <el-form-item label="" prop="password_val">
        <el-input type="password" placeholder="name" v-model="name" autocomplete="off"></el-input>
      </el-form-item>
      <el-form-item label="" prop="email_val">
        <el-input type="text" placeholder="sex" v-model="sex" autocomplete="off"></el-input>
      </el-form-item>
      <el-form-item label="" prop="age_val">
        <el-input type="text" placeholder="age" v-model="age" autocomplete="off"></el-input>
      </el-form-item>
      <el-form-item label="" prop="dept_val">
        <el-input type="text" placeholder="depatment" v-model="dept" autocomplete="off"></el-input>
      </el-form-item>
      <el-form-item>
  ...
  data:function(){
    return {
      ...
      rules: {
        ...
        password_val: [
          {required: true, message: 'name不可为空', trigger: 'blur'}
        ],
        email_val:[
          {required: true,message:'sex不可为空',trigger:'blur'}
        ]
      },
    }
  },
